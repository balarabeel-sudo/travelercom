...
type Step = 'details' | 'guest' | 'dates' | 'participants' | 'payment' | 'summary'
const STEP_ORDER: Step[] = ['details', 'guest', 'dates', 'participants', 'payment', 'summary']
const STEP_LABELS: { key: Step; label: string }[] = [
  { key: 'details', label: 'Tour' },
