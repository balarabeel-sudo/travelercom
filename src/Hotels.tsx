        ...
        <div style={{ background: COLORS.card, borderRadius: '16px', padding: '14px', boxShadow: '0 2px 10px rgba(0,0,0,0.06)', marginBottom: '14px' }}>
          <div style={{ background: '#F0F9FF', border: `1px solid ${COLORS.border}`, borderRadius: '12px', padding: '10px 12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <input value={destination} onChange={(e) => setDestination(e.target.value)} placeholder="City / Location" style={{ border: 'none', outline: 'none', background: 'transparent', fontSize: '14px', fontWeight: 700, color: COLORS.text, width: '100%', padding: 0 }} />
            </div>
          </div>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ marginTop: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '8px' }}>
                    <div>
                      ...
                      <p style={{ fontSize: '10.5px', fontWeight: 700, color: !availCount ? '#DC2626' : COLORS.green }}>
                        {!availCount ? 'Not available' : 'Available'}
                      </p>
                    </div>
