...
const ADDON_PRICES = { luggage: 3000, insurance: 1500 }
...
const STEPS = ['Trip', 'Passenger', 'Extras', 'Payment', 'Review']
  ...
  const downloadReceipt = () => {
    ...
    downloadReceiptImage({
      ...
      rows: [
        ...
        { label: 'Train Operator', value: service.companies?.business_name || 'Traveler.com Partner' },
      ],
    })
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: COLORS.bg, paddingBottom: '110px' }}>
      ...
      <div className="no-print" style={{ background: COLORS.navy, padding: '18px 20px 22px', color: 'white' }}>
        ...
        <p style={{ fontSize: '17px', fontWeight: 800, marginTop: '10px' }}>Book Your Train Trip</p>
        {step <= 5 && (
      ...
      <div style={{ maxWidth: '480px', margin: '0 auto', padding: '20px' }}>
            ...
            <div style={{ ...cardStyle, padding: 0, overflow: 'hidden' }}>
              <div style={{ height: '150px', background: `linear-gradient(135deg, ${COLORS.navy}, ${COLORS.primary})`, position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '16px' }}>
                  <p style={{ color: 'white', fontSize: '11px', fontWeight: 700, letterSpacing: '0.5px', display: 'flex', alignItems: 'center', gap: '5px' }}><Icon name="train" size={12} color="white" /> {service.companies?.business_name || 'Traveler.com Partner'}</p>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '18px' }}>
                  ...
                  <div style={{ flex: 1, textAlign: 'center' as const, padding: '0 10px' }}>
                    ...
                    <div style={{ height: '1px', background: COLORS.border, margin: '6px 0', position: 'relative' }}>
                      <span style={{ position: 'absolute', right: 0, top: '-9px', display: 'flex' }}><Icon name="train" size={14} color={COLORS.textMuted} /></span>
                    </div>
                  </div>
                  <div style={{ textAlign: 'center' as const }}>
        ...
        {step === 2 && (
          <div style={cardStyle}>
            ...
            <p style={{ fontSize: '10.5px', color: COLORS.textMuted, fontStyle: 'italic' as const }}>
              Identity information is required by the operator for passenger verification.
            </p>
          </div>
        )}
        ...
        {step === 3 && (
          <div style={cardStyle}>
            ...
            {[
              { key: 'luggage', label: 'Extra Luggage', price: ADDON_PRICES.luggage, val: extraLuggage, set: setExtraLuggage },
        ...
        {step === 5 && (
          <div style={cardStyle}>
            ...
            {[
              ...
              ['Train Operator', service.companies?.business_name || 'Traveler.com Partner'],
